...
def client_handler(client):
    ...
    while 1:
        ...
        if username != '':
            ...
            prompt_message = "[SERVER]" + f" {dec_rot13(username)} added to the chat"
            
            dec_message = dec_rot13(prompt_message)
            send_messages_to_all(dec_message)
            break
        else:
...
def main():
    ...
    while 1:
        ...
        print(f"Client is connected {address[0]} {address[1]}")
